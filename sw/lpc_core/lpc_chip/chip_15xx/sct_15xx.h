...
typedef struct {
	...
	__IO union {
		uint32_t U;					/*!<       FRACMATREL[i].U  Unified 32-bit register */
		struct {
			uint16_t L;				/*!<       FRACMATREL[i].L  Access to L value */
			uint16_t H;				/*!<       FRACMATREL[i].H  Access to H value */
		};
...
#define SCT_EVE_6                 (1 << 6)
#define SCT_EVE_7                 (1 << 7)
#define SCT_EVE_8                 (1 << 8)
#define SCT_EVE_9                 (1 << 9)
#define SCT_EVE_10                (1 << 10)
#define SCT_EVE_11                (1 << 11)
#define SCT_EVE_12                (1 << 12)
#define SCT_EVE_13                (1 << 13)
#define SCT_EVE_14                (1 << 14)
#define SCT_EVE_15                (1 << 15)
...
typedef enum CHIP_SCT_OUTPUT_REG {
	...
	SCT_OUTPUT_4 = 4,	/*!< SCT Output register 4 */
	SCT_OUTPUT_5 = 5,	/*!< SCT Output register 5 */
	SCT_OUTPUT_6 = 6,	/*!< SCT Output register 6 */
	SCT_OUTPUT_7 = 7,	/*!< SCT Output register 7 */
	SCT_OUTPUT_8 = 8,	/*!< SCT Output register 8 */
	SCT_OUTPUT_9 = 9,	/*!< SCT Output register 9 */
	SCT_OUTPUT_10 = 10	/*!< SCT Output register 10 */
} CHIP_SCT_OUTPUT_REG_T;


/**
 * SCT Fractional Match register values enum
 */
typedef enum CHIP_SCT_FRAMATCH_REG {
	SCT_FRAMATCH_0 = 0,	/*!< SCT FRAMATCH register 0 */
	SCT_FRAMATCH_1 = 1,	/*!< SCT FRAMATCH register 1 */
	SCT_FRAMATCH_2 = 2,	/*!< SCT FRAMATCH register 2 */
	SCT_FRAMATCH_3 = 3,	/*!< SCT FRAMATCH register 3 */
	SCT_FRAMATCH_4 = 4,	/*!< SCT FRAMATCH register 4 */
	SCT_FRAMATCH_5 = 5	/*!< SCT FRAMATCH register 5 */
} CHIP_SCT_FRAMATCH_REG_T;
...
typedef enum CHIP_SCT_EVENT_REG {
	...
	SCT_EVENT_6 = 6,		/*!< SCT EVENT register 6 */
	SCT_EVENT_7 = 7,		/*!< SCT EVENT register 7 */
	SCT_EVENT_8 = 8,		/*!< SCT EVENT register 8 */
	SCT_EVENT_9 = 9,		/*!< SCT EVENT register 9 */
	SCT_EVENT_10 = 10,		/*!< SCT EVENT register 10 */
	SCT_EVENT_11 = 11,		/*!< SCT EVENT register 11 */
	SCT_EVENT_12 = 12,		/*!< SCT EVENT register 12 */
	SCT_EVENT_13 = 13,		/*!< SCT EVENT register 13 */
	SCT_EVENT_14 = 14,		/*!< SCT EVENT register 14 */
	SCT_EVENT_15 = 15,		/*!< SCT EVENT register 15 */
...
typedef enum CHIP_SCT_CAPCTRL_REG {
	...
	SCT_CAPCTRL_5 = 5,		/*!< SCT CAPCTRL register 5 */
	SCT_CAPCTRL_6 = 6,		/*!< SCT CAPCTRL register 6 */
	SCT_CAPCTRL_7 = 7,		/*!< SCT CAPCTRL register 7 */
	SCT_CAPCTRL_8 = 8,		/*!< SCT CAPCTRL register 8 */
	SCT_CAPCTRL_9 = 9,		/*!< SCT CAPCTRL register 9 */
	SCT_CAPCTRL_10 = 10,	/*!< SCT CAPCTRL register 10 */
	SCT_CAPCTRL_11 = 11,	/*!< SCT CAPCTRL register 11 */
	SCT_CAPCTRL_12 = 12,	/*!< SCT CAPCTRL register 12 */
	SCT_CAPCTRL_13 = 13,	/*!< SCT CAPCTRL register 13 */
	SCT_CAPCTRL_14 = 14,	/*!< SCT CAPCTRL register 14 */
	SCT_CAPCTRL_15 = 15,	/*!< SCT CAPCTRL register 15 */
...
/**
 * @brief	Fractional Match Register in State Configurable Timer
 * @param	pSCT	: The base of SCT peripheral on the chip
 * @param	n		: Fractional match register value
 * @param	value	: The 32-bit Fractional match count value
 * @return	Nothing
 */
STATIC INLINE void Chip_SCT_FractionalMatch(LPC_SCT_T *pSCT, CHIP_SCT_FRAMATCH_REG_T n, uint32_t value)
{
	pSCT->FRACMATREL[n].U = value;
}
...
/**
 * @brief	Get unified match reload Lower count value in State Configurable Timer
 * @param	pSCT	: The base of SCT peripheral on the chip
 * @param	n		: Match register value
 * @return	16-bit match reload
 */
STATIC INLINE uint16_t Chip_SCT_GetMatchReloadL(LPC_SCT_T *pSCT, CHIP_SCT_MATCH_REG_T n)
{
	return pSCT->MATCHREL[n].L;
}
...
/**
 * @brief	Gett unified match reload Higher count value in State Configurable Timer
 * @param	pSCT	: The base of SCT peripheral on the chip
 * @param	n		: Match register value
 * @return	16-bit match reload
 */
STATIC INLINE uint16_t Chip_SCT_GetMatchReloadH(LPC_SCT_T *pSCT, CHIP_SCT_MATCH_REG_T n)
{
	return pSCT->MATCHREL[n].H;
}
...
/**
 * @brief	SET the specified event flag in Status Configurable Timer
 * @param	pSCT	: The base of SCT peripheral on the chip
 * @param	evt		: Event value
 * @return	Nothing
 */
STATIC INLINE void Chip_SCT_SetEventFlag(LPC_SCT_T  *pSCT, CHIP_SCT_EVENT_T evt)
{
	 pSCT->EVFLAG = evt ;
}
/**
...
/**
 * @brief	Clear Output register in State Configurable Timer
 * @param	pSCT	: The base of SCT peripheral on the chip
 * @param	value	: Value (ORed value of SCT_CTRL_* bits)
 * @return	Nothing
 */
STATIC INLINE void Chip_SCT_ClearoutputdirControl(LPC_SCT_T *pSCT, CHIP_SCT_EVENT_T value)
{
	pSCT->OUTPUTDIRCTRL &= ~(value);
}
/**
